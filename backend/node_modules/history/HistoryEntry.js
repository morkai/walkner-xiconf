...
const TELEMANAGEMENT_MODES = {
  F: 'FutureProof',
  T: 'Telemanaged'
};
const SWITCH_REGIMES = {
  A: 'AlwaysOn',
  P: 'PhotoCell'
};
const PHOTO_CELL_LEVELS = {
  _: 'Levels_Unknown',
  A: 'Levels_38_18',
  B: 'Levels_55_28',
  C: 'Levels_70_35',
...
HistoryEntry.prototype.save = function(featureDbPath, done)
{
  ...
  function saveInDb(done)
  {
    ...
    `;
    const params = {
      $_id: historyEntry._id, // eslint-disable-line camelcase
      $_order: historyEntry.order ? historyEntry.order._id : null, // eslint-disable-line camelcase

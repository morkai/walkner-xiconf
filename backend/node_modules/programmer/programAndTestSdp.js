...
module.exports = function programAndTestSdp(app, programmerModule, done)
{
  ...
  function monitorReadingsDuringSol(uSet, sdpMaster, metrics, isMonitoringStopped)
  {
    ...
    sdpMaster.GETD(function(err, res) // eslint-disable-line new-cap
    {
      if (!err)
      {
  ...
  function readCurrentReadings(options, done)
  {
    ...
    options.sdpMaster.GETD(function(err, res) // eslint-disable-line new-cap
    {
      if (programmerModule.cancelled)
      {
        return done();
  ...
  function handlePeStepMetrics(rMax, options, metrics)
  {
    ...
    {
      throw 'TESTING_MAX_RESISTANCE'; // eslint-disable-line no-throw-literal
    }
  ...
  function handleFnStepMetrics(pMin, pMax, options, metrics)
  {
    if (metrics.time >= options.monitoringStartTime)
    {
      if (metrics.p > pMax)
      {
        throw 'TESTING_MAX_POWER'; // eslint-disable-line no-throw-literal
      }

      if (metrics.p < pMin)
      {
        throw 'TESTING_MIN_POWER'; // eslint-disable-line no-throw-literal
      }
    }

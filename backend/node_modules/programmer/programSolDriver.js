...
module.exports = function programSolDriver(app, programmerModule, output, onProgress, done)
{
  ...
  step(
    ...
    function setNumberBaseStep(err)
    {
      ...
      execCommand(programmerModule, this.serialPort, this.output, 'set base 10', progress, function(err, result) // eslint-disable-line handle-callback-err
      {
...
function createExecGetCommandStep(fake, programmerModule, serialPort, output, command, progress)
{
  return function execGetCommandStep(err)
  {
    ...
    execCommand(programmerModule, serialPort, output, command.getCmd, progress, function(err, result) // eslint-disable-line handle-callback-err
    {

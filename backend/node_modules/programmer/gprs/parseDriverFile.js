...
var featureHandlers = {
  ...
  InterfaceSelection: function(driverData, itemValues)
  {
    itemValues.forEach(function(itemValue)
    {
      ...
      {
        const value = itemValue.Data[0].Rows[0].SerializeDataRow[0].Values[0].anyType[0]._;

        driverData.dynaDimmerEnabled = parseInt(value, 10) === 2;
      }
    });
  },
...
function parseDriverXml(xml)
{
  ...
  {
    throw 'GPRS:PARSING_DRIVER_FILE_FAILURE'; // eslint-disable-line no-throw-literal
  }

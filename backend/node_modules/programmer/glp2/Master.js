...
const NoConnectionError = require('./NoConnectionError');
const InvalidParametersError = require('./InvalidParametersError');
const ResponseTimeoutError = require('./ResponseTimeoutError');
const InvalidResponseError = require('./InvalidResponseError');
const InvalidChecksumError = require('./InvalidChecksumError');
const BusyTesterError = require('./BusyTesterError');
const PeTest = require('./PeTest');
const IsoTest = require('./IsoTest');
const FctTest = require('./FctTest');
const VisTest = require('./VisTest');
const ActualValuesResponse = require('./ActualValuesResponse');
const OrderDataDemandResponse = require('./OrderDataDemandResponse');
const InterimActualValuesResponse = require('./InterimActualValuesResponse');
const DeviceOptionsResponse = require('./DeviceOptionsResponse');
 ...
 * @type {string}
 */
const DEFAULT_PROGRAM_NAME = 'TEST';
...
Master.prototype.send = function(requestBuffer, responseHandler, done)
{
  if (this.serialPort === null)
  {
    done(new NoConnectionError(), null);

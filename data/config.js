...
config.programmer.workflowFile = path.join(DATA_PATH, 'walkner-xiconf-workflow.txt');
config.programmer.lastModeFile = path.join(DATA_PATH, 'walkner-xiconf-mode.txt');
